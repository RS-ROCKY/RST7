...
888   T88b  "Y8888P"     888     
                   
\033[1;91m--------------------------------------------
\033[1;91m[*] CREATOR   > Rabby
\033[1;91m[*] FACEBOOK  > Rs Rabby 
\033[1;91m[*] GITHUB    > RS-ROCKY
\033[1;91m[*] VERSION   > FREE
\033[1;91m[*] WHATSAPP  > +88608069783
\033[1;91m-------------------------------------------"""  )
...
def mex():
    ...
    try:
        ...
        os.system('am start https://wa.me/+8801608069753?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20PARVEJ%20Paid%20Tools.%20My%20Key:%20'+key1)
        mex()
    r = requests.get('https://wa.me/+8801608069753/PARVEJ/approved.txt/main/approved.%20txt').text
    if key1 in r:
